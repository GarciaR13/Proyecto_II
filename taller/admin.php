...
// 5. Consulta para mostrar la tabla
...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            left: 0; top: 0; background-color: #000000;
        ...
        .btn-outline-black { background: #fff; color: #000; border: 1px solid #000; border-radius: 0; }
        .btn-outline-black:hover { background: #000; color: #fff; }
        .alert-bn { border: 2px solid #000; background: #fff; color: #000; font-weight: bold; }
    </style>
</head>
<body>
                    ...
                    <?php if ($resUsuarios): ?>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <img src="<?php echo !empty($user['img']) ? $user['img'] : 'https://via.placeholder.com/40/000?text=U'; ?>" 
    ...
    <div id="modalEditar" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:2000;">
        <div style="background:white; width:400px; margin:100px auto; padding:20px; border: 3px solid #000; box-shadow: 10px 10px 0px #000;">
            <h4 class="fw-bold">EDITAR DATOS</h4>
